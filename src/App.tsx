...
function App() {
    ...
    const [sauce, setSauce] = useState('mayo');
    ...
    const handleSubmit = (event:FormEvent<HTMLFormElement>) =>{
        ...
        const sandwich:Sandwich = { name, bread, meat, salad1, salad2, salad3, sauce, cheese, beverage, extra, toasted, wishes };
    ...
    return (
        <div className="App">
            ...
            <form onSubmit={handleSubmit} className={"sandwich"}>
                ...
                <button type={"submit"}> Order your Sandwich </button>
            </form>
        </div>
    );
}
